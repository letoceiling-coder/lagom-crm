<template>
    <router-link :to="`/${slug}${decision.slug}`" class="block">
        <div class="flex flex-col justify-between h-[82px] p-3 bg-[#F4F4F4] rounded-lg transition-all duration-200 hover:shadow-md hover:bg-gray-50">
            <div class="name text-sm sm:text-base font-normal text-gray-900 leading-tight mb-2">
                {{ decision.name }}
            </div>
            <div class="flex items-center justify-end gap-2">
                <span class="text-xs sm:text-sm font-normal text-[#688E67]">подробнее</span>
